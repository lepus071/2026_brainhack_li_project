...
**Group-level VPA maps** (R² thresholded at 0.01, glass-brain projections; generated by `codes/version_2/run_nilearn_render.py`, Phase 8B):

| Unique $x_f$ | Unique $x_s$ |
|---|---|
| ![Unique_xf](figures/VPA_Map_Unique_xf_R2_GlassBrain.png) | ![Unique_xs](figures/VPA_Map_Unique_xs_R2_GlassBrain.png) |

| Shared $x_f$–$x_s$ | Full ($x_f$+$x_s$) |
|---|---|
| ![Shared_xf_xs](figures/VPA_Map_Shared_xf_xs_R2_GlassBrain.png) | ![Full_xf_xs](figures/VPA_Map_Full_xf_xs_R2_GlassBrain.png) |
