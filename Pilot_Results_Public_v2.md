...
**Sample**: N=10 subjects (sub-01–04, 06–11). **Status**: Phases 0A–7 complete end-to-end for the 2-variable pipeline (`codes/version_2/`, a fully self-contained pipeline); Phase 8 (interactive HTML / surface rendering) pending for this version.
...
- **Phase 8 (interactive HTML / surface rendering)** for the 2-variable maps is not yet run — affects presentation only, not the numerical results above.
