...
- **Phase 5 — Inverse VPA Mapping**: The VPA results exist as 481-length vectors (one value per ROI). This stage projects those vectors back into whole-brain NIfTI volumes so the results can be visualized and interpreted anatomically.
