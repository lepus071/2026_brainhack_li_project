#!/usr/bin/env python3
# ==============================================================================
# run_marginal_r2_analysis.py  (version_2: Smith et al. 2006 dual-rate, 2-var)
#
# Follow-up to Phase 4 (run_hybrid_group_decoding.py):
#
# Instead of the VPA unique/shared decomposition (full - reduced subtraction,
# which is sensitive to collinearity between x_f and x_s), this script reports
...
def main():
    ...
    print("\nDone. Saved Marginal_{xf,xs}_R2_{raw,detrend}.npy to ml_results_v2/.")
